let isBoss = confirm("¿Quiéres entrar al sitio web?");

if (isBoss == true) { // Es necesario mantener dos iguales o detectará ambas opciones como true.
...
let empezar = alert("Vamos a empezar.")
